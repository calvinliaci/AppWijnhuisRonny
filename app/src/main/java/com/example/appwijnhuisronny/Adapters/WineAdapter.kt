...
class WineAdapter(private val addToCartClickListener: (Wine) -> Unit) : RecyclerView.Adapter<WineAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.addToCartButton.setOnClickListener {
            ...
            Log.d("WineAdapter", "Item added to cart: $currentItem")
        }
    }
